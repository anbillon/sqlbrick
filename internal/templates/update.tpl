...
{{- end }}
{{ if .IsTx -}}
func (b *{{ .BrickName }}BrickTx){{ .FuncName }}({{- if .WithContext -}}ctx context.Context, {{ end }}args *entity.{{ .BrickName }}) (int64, error) {
{{- else -}}
func (b *{{ .BrickName }}Brick){{ .FuncName }}({{- if .WithContext -}}ctx context.Context, {{ end }}args *entity.{{ .BrickName }}) (int64, error) {
{{- end -}}
