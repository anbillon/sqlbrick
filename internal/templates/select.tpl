...
{{- if gt .TotalArgs 0 }}
{{ if .IsTx -}}
func (b *{{ .BrickName }}BrickTx){{ .FuncName }}({{- if .WithContext -}}ctx context.Context, {{ end }}dest interface{}, {{ .ArgName }} interface{}) error {
{{ else -}}
func (b *{{ .BrickName }}Brick){{ .FuncName }}({{- if .WithContext -}}ctx context.Context, {{ end }}dest interface{}, {{ .ArgName }} interface{}) error {
{{- end -}}
    {{ if .IsTx -}}
